...
public class SqlQ02 {
    ...
    static String myQuery = "select deptno, count(empno), avg(sal) from emp group by deptno";

    public static void main(String[] args) {

        if (args.length != 1) {
            System.out.println("Usage: SqlQ02 outputPath");
            System.exit(1);
        }
        String outPath = args[0];

        SparkConf sparkConf = new SparkConf().setAppName("Java-SqlQuery-02");
...
// spark-submit --master yarn-client --class SparkSQLJava.SqlQ02 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q002
// spark-submit --master local[4] --class SparkSQLJava.SqlQ02 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q002
