...
public class SqlQ05 {
    ...
    static String myQuery = "select e.ename, e.sal from emp e JOIN emp e2 ON e.mgr = e2.empno where e.sal > e2.sal";

    public static void main(String[] args) {

        if (args.length != 1) {
            System.out.println("Usage: SqlQ05 outputPath");
            System.exit(1);
        }
        String outPath = args[0];

        SparkConf sparkConf = new SparkConf().setAppName("Java-SqlQuery-05");
...
// spark-submit --master yarn-client --class SparkSQLJava.SqlQ05 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q005
// spark-submit --master local[4] --class SparkSQLJava.SqlQ05 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q005
