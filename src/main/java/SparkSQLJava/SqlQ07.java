...
public class SqlQ07 {
    ...
    static String myQuery = "select emp.ename, dept.dname from emp JOIN dept on  \n" +
            "  emp.deptno=dept.deptno and emp.ename like 'J%'";

    public static void main(String[] args) {

        if (args.length != 1) {
            System.out.println("Usage: SqlQ07 outputPath");
            System.exit(1);
        }
        String outPath = args[0];

        SparkConf sparkConf = new SparkConf().setAppName("Java-SqlQuery-07");
...
// spark-submit --master yarn-client --class SparkSQLJava.SqlQ07 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q007
// spark-submit --master local[4] --class SparkSQLJava.SqlQ07 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q007
