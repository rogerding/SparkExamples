...
public class SqlQ08 {
    ...
    static String myQuery = "select ename, sal from emp order by sal desc limit 3";

    public static void main(String[] args) {

        if (args.length != 1) {
            System.out.println("Usage: SqlQ08 outputPath");
            System.exit(1);
        }
        String outPath = args[0];

        SparkConf sparkConf = new SparkConf().setAppName("Java-SqlQuery-08");
...
// spark-submit --master yarn-client --class SparkSQLJava.SqlQ08 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q008
// spark-submit --master local[4] --class SparkSQLJava.SqlQ08 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q008
