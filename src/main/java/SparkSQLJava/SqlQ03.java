...
public class SqlQ03 {
    ...
    static String myQuery = "select e.deptno, e.ename, e.hiredate from (select deptno, min(cast(hiredate as date)) as mindate from emp group by deptno) a JOIN emp e on e.hiredate=a.mindate AND e.deptno=a.deptno";

    public static void main(String[] args) {

        if (args.length != 1) {
            System.out.println("Usage: SqlQ03 outputPath");
            System.exit(1);
        }
        String outPath = args[0];

        SparkConf sparkConf = new SparkConf().setAppName("Java-SqlQuery-03");
...
// spark-submit --master yarn-client --class SparkSQLJava.SqlQ03 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q003
// spark-submit --master local[4] --class SparkSQLJava.SqlQ03 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q003
