...
public class SqlQ09 {
    ...
    static String myQuery = "select ename, sal+comm as income from emp order by income";

    public static void main(String[] args) {

        if (args.length != 1) {
            System.out.println("Usage: SqlQ09 outputPath");
            System.exit(1);
        }
        String outPath = args[0];

        SparkConf sparkConf = new SparkConf().setAppName("Java-SqlQuery-09");
...
// spark-submit --master yarn-client --class SparkSQLJava.SqlQ09 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q009
// spark-submit --master local[4] --class SparkSQLJava.SqlQ09 /home/cloudera/IdeaProjects/SparkExamples/target/SparkExamples-1.0-SNAPSHOT.jar hdfs://quickstart.cloudera:8020/user/cloudera/class/q009
